# KKKKKK[script opensource by tsuo.txt](https://github.com/user-attachments/files/24551519/script.opensource.by.tsuo.txt)
...
local Window = OrionLib:MakeWindow({Name = "DK Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "DK Hub"})
